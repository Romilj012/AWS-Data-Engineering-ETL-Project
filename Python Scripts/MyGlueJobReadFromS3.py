...
AmazonS3_node1728088491120 = glueContext.create_dynamic_frame.from_catalog(database="mydatabase", table_name="product", transformation_ctx="AmazonS3_node1728088491120")

logger.info('print schema of S3bucket_node1')
AmazonS3_node1728088491120.printSchema()

count = AmazonS3_node1728088491120.count()
print("Number of rows in S3bucket_node1 dynamic frame: ", count)
logger.info('count for frame is {}'.format(count))

# Script generated for node ApplyMapping
ApplyMapping_node2 = ApplyMapping.apply(
    frame=AmazonS3_node1728088491120,
    mappings=[
...
# Script generated for node Amazon S3
AmazonS3_node1728088493884 = glueContext.write_dynamic_frame.from_options(frame=dynamic_frame, connection_type="s3", format="glueparquet", connection_options={"path": "s3://etl-data-engineering-project/output/", "partitionKeys": []}, format_options={"compression": "snappy"}, transformation_ctx="AmazonS3_node1728088493884")
